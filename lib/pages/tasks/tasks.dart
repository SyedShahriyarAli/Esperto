  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          ToggleButtons(
            selectedBorderColor: DarkTheme.blueColor,
            selectedColor: DarkTheme.fontColor,
            fillColor: DarkTheme.blueColor,
                ...
                Theme(
                  ...
                  child: tasks.isEmpty
                      ? const Center(
                          ...
                          style: TextStyle(
                              color: DarkTheme.borderColor, fontSize: 24),
                      ...
                      : ReorderableListView(
                          ...
                          children: <Widget>[
                            for (final task
                                in tasks
                                    .where((e) => e.completed == !isSelected[0])
                                    .toList()
                                  ..sort((a, b) {
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border:
                                      Border.all(color: DarkTheme.borderColor),
